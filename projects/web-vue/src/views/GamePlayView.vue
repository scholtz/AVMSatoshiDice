...
<template>
  <AuthScreen>
    <div class="mb-6 flex items-center space-x-2">
      <AppButton @click="router.push(`/game/${gameId}`)" variant="outline" class="px-3 py-1.5">
      ...
      <h1 class="text-2xl font-bold text-white">Play Game</h1>
    </div>
    ...
    <GamePlay v-else :game="gameStore.currentGame" @play-complete="handlePlayComplete" />
  </AuthScreen>
</template>
