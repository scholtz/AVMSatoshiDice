 ...
 */
export function GameStructFromTuple(abiTuple: [bigint, bigint, boolean, boolean, boolean, bigint, bigint, bigint, bigint, bigint, bigint, bigint, bigint, string]) {
...
export type AvmSatoshiDiceArgs = {
  ...
  obj: {
    ...
    'CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)': {
      /**
       * Deposit transaction
       */
    ...
    'CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)': {
      /**
       * Deposit transaction
       */
      txnDeposit: AppMethodCallTransactionArgument
    ...
    'CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)': {
      assetId: bigint | number
      amount: bigint | number
      /**
       * Win ratio.. 1_000_000 for user probability, 200_000 for 0.2 factor of the user probability, 0 for no win
    ...
    'Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)': {
      creator: string
      assetId: bigint | number
    }
  ...
  tuple: {
    ...
    'CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)': [txnDeposit: AppMethodCallTransactionArgument, winRatio: bigint | number]
    'OptInToASA(pay,uint64)void': [txnDeposit: AppMethodCallTransactionArgument, assetId: bigint | number]
    'CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)': [txnDeposit: AppMethodCallTransactionArgument, winRatio: bigint | number]
    'CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)': [assetId: bigint | number, amount: bigint | number, winRatio: bigint | number]
    ...
    'Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)': [creator: string, assetId: bigint | number]
...
export type AvmSatoshiDiceReturns = {
  ...
  'CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)': GameStruct
  'OptInToASA(pay,uint64)void': void
  'CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)': GameStruct
  'CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)': GameStruct
  ...
  'Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)': GameStruct
...
export type AvmSatoshiDiceTypes = {
  ...
  methods:
    ...
    & Record<'CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)' | 'CreateGameWithNativeToken', {
      argsObj: AvmSatoshiDiceArgs['obj']['CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']
      argsTuple: AvmSatoshiDiceArgs['tuple']['CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']
      returns: AvmSatoshiDiceReturns['CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']
    }>
    ...
    & Record<'CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)' | 'CreateGameWithASAToken', {
      argsObj: AvmSatoshiDiceArgs['obj']['CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']
      argsTuple: AvmSatoshiDiceArgs['tuple']['CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']
      returns: AvmSatoshiDiceReturns['CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']
    }>
    & Record<'CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)' | 'CreateGameWithArc200Token', {
      argsObj: AvmSatoshiDiceArgs['obj']['CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']
      argsTuple: AvmSatoshiDiceArgs['tuple']['CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']
      returns: AvmSatoshiDiceReturns['CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']
    }>
    ...
    & Record<'Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)' | 'Game', {
      argsObj: AvmSatoshiDiceArgs['obj']['Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']
      argsTuple: AvmSatoshiDiceArgs['tuple']['Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']
      /**
       * the current game
       */
      returns: AvmSatoshiDiceReturns['Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']
    }>
...
export abstract class AvmSatoshiDiceParamsFactory {
  ...
  /**
   * Constructs a no op call for the CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address) ABI method
   *
   ...
   * @returns An `AppClientMethodCallParams` object for the call
   */
  static createGameWithNativeToken(params: CallParams<AvmSatoshiDiceArgs['obj']['CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | AvmSatoshiDiceArgs['tuple']['CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
      method: 'CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)' as const,
  ...
  /**
   * Constructs a no op call for the CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address) ABI method
   *
   * Create new game or deposit by the owner more assets to the game.
   *
   * @param params Parameters for the call
   * @returns An `AppClientMethodCallParams` object for the call
   */
  static createGameWithAsaToken(params: CallParams<AvmSatoshiDiceArgs['obj']['CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | AvmSatoshiDiceArgs['tuple']['CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
      method: 'CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)' as const,
      args: Array.isArray(params.args) ? params.args : [params.args.txnDeposit, params.args.winRatio],
    }
  }
  /**
   * Constructs a no op call for the CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address) ABI method
   *
   * Create new game or deposit by the owner more assets to the game.
   *
   * @param params Parameters for the call
   * @returns An `AppClientMethodCallParams` object for the call
   */
  static createGameWithArc200Token(params: CallParams<AvmSatoshiDiceArgs['obj']['CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | AvmSatoshiDiceArgs['tuple']['CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
      method: 'CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)' as const,
  ...
  * Starts new game play
  ...
  /**
   * Constructs a no op call for the Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address) ABI method
   *
   ...
   * @returns An `AppClientMethodCallParams` object for the call
   */
  static game(params: CallParams<AvmSatoshiDiceArgs['obj']['Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | AvmSatoshiDiceArgs['tuple']['Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
      method: 'Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)' as const,
...
export class AvmSatoshiDiceClient {
  ...
  readonly params = {
    ...
    /**
     * Makes a call to the AvmSatoshiDice smart contract using the `CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)` ABI method.
     *
     * Create new game or deposit by the owner more assets to the game.
     *
     * @param params The params for the smart contract call
    ...
    /**
     * Makes a call to the AvmSatoshiDice smart contract using the `CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)` ABI method.
     *
     * Create new game or deposit by the owner more assets to the game.
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    createGameWithAsaToken: (params: CallParams<AvmSatoshiDiceArgs['obj']['CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | AvmSatoshiDiceArgs['tuple']['CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.params.call(AvmSatoshiDiceParamsFactory.createGameWithAsaToken(params))
    },

    /**
     * Makes a call to the AvmSatoshiDice smart contract using the `CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)` ABI method.
     *
     * Create new game or deposit by the owner more assets to the game.
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    createGameWithArc200Token: (params: CallParams<AvmSatoshiDiceArgs['obj']['CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | AvmSatoshiDiceArgs['tuple']['CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
    ...
    * Starts new game play
    ...
    /**
     * Makes a call to the AvmSatoshiDice smart contract using the `Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)` ABI method.
     * 
     ...
     */
    game: (params: CallParams<AvmSatoshiDiceArgs['obj']['Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | AvmSatoshiDiceArgs['tuple']['Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
  ...
  readonly send = {
     ...
     * @returns The call result
     */
    createGameWithNativeToken: async (params: CallParams<AvmSatoshiDiceArgs['obj']['CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | AvmSatoshiDiceArgs['tuple']['CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(AvmSatoshiDiceParamsFactory.createGameWithNativeToken(params))
      return {...result, return: result.return as unknown as (undefined | AvmSatoshiDiceReturns['CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'])}
    },
     ...
     * @returns The call result
     */
    createGameWithAsaToken: async (params: CallParams<AvmSatoshiDiceArgs['obj']['CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | AvmSatoshiDiceArgs['tuple']['CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(AvmSatoshiDiceParamsFactory.createGameWithAsaToken(params))
      return {...result, return: result.return as unknown as (undefined | AvmSatoshiDiceReturns['CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'])}
    },
     ...
     * @returns The call result
     */
    createGameWithArc200Token: async (params: CallParams<AvmSatoshiDiceArgs['obj']['CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | AvmSatoshiDiceArgs['tuple']['CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(AvmSatoshiDiceParamsFactory.createGameWithArc200Token(params))
      return {...result, return: result.return as unknown as (undefined | AvmSatoshiDiceReturns['CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'])}
    },
    ...
    * Starts new game play
     ...
     */
    game: async (params: CallParams<AvmSatoshiDiceArgs['obj']['Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | AvmSatoshiDiceArgs['tuple']['Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(AvmSatoshiDiceParamsFactory.game(params))
      return {...result, return: result.return as unknown as (undefined | AvmSatoshiDiceReturns['Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'])}
    },
  ...
  /**
   * Makes a readonly (simulated) call to the AvmSatoshiDice smart contract using the `Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)` ABI method.
   * 
   * This method is a readonly method; calling it with onComplete of NoOp will result in a simulated transaction rather than a real transaction.
   *
   * Returns the current state of the game
   ...
   * @returns The call result: the current game
   */
  async game(params: CallParams<AvmSatoshiDiceArgs['obj']['Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | AvmSatoshiDiceArgs['tuple']['Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']>) {
    const result = await this.appClient.send.call(AvmSatoshiDiceParamsFactory.game(params))
    return result.return as unknown as AvmSatoshiDiceReturns['Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']
  }
  ...
  public newGroup(): AvmSatoshiDiceComposer {
    ...
    return {
      ...
      /**
       * Add a CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address) method call against the AvmSatoshiDice contract
       */
      createGameWithNativeToken(params: CallParams<AvmSatoshiDiceArgs['obj']['CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | AvmSatoshiDiceArgs['tuple']['CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.createGameWithNativeToken(params)))
        resultMappers.push((v) => client.decodeReturnValue('CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)', v))
        return this
      },
      /**
      ...
      /**
       * Add a CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address) method call against the AvmSatoshiDice contract
       */
      createGameWithAsaToken(params: CallParams<AvmSatoshiDiceArgs['obj']['CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | AvmSatoshiDiceArgs['tuple']['CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.createGameWithAsaToken(params)))
        resultMappers.push((v) => client.decodeReturnValue('CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)', v))
        return this
      },
      /**
       * Add a CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address) method call against the AvmSatoshiDice contract
       */
      createGameWithArc200Token(params: CallParams<AvmSatoshiDiceArgs['obj']['CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | AvmSatoshiDiceArgs['tuple']['CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.createGameWithArc200Token(params)))
        resultMappers.push((v) => client.decodeReturnValue('CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)', v))
        return this
      },
      /**
      ...
      /**
       * Add a Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address) method call against the AvmSatoshiDice contract
       */
      game(params: CallParams<AvmSatoshiDiceArgs['obj']['Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | AvmSatoshiDiceArgs['tuple']['Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.game(params)))
        resultMappers.push((v) => client.decodeReturnValue('Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)', v))
        return this
      },
      /**
...
export type AvmSatoshiDiceComposer<TReturns extends [...any[]] = []> = {
  ...
  /**
   * Calls the CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address) ABI method.
   *
   * Create new game or deposit by the owner more assets to the game.
   *
   * @param args The arguments for the contract call
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  createGameWithNativeToken(params?: CallParams<AvmSatoshiDiceArgs['obj']['CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | AvmSatoshiDiceArgs['tuple']['CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']>): AvmSatoshiDiceComposer<[...TReturns, AvmSatoshiDiceReturns['CreateGameWithNativeToken(pay,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | undefined]>
  ...
  /**
   * Calls the CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address) ABI method.
   *
   * Create new game or deposit by the owner more assets to the game.
   *
   * @param args The arguments for the contract call
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  createGameWithAsaToken(params?: CallParams<AvmSatoshiDiceArgs['obj']['CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | AvmSatoshiDiceArgs['tuple']['CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']>): AvmSatoshiDiceComposer<[...TReturns, AvmSatoshiDiceReturns['CreateGameWithASAToken(axfer,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | undefined]>

  /**
   * Calls the CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address) ABI method.
   *
   * Create new game or deposit by the owner more assets to the game.
   *
   * @param args The arguments for the contract call
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  createGameWithArc200Token(params?: CallParams<AvmSatoshiDiceArgs['obj']['CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | AvmSatoshiDiceArgs['tuple']['CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']>): AvmSatoshiDiceComposer<[...TReturns, AvmSatoshiDiceReturns['CreateGameWithArc200Token(uint64,uint256,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | undefined]>
  ...
  * Starts new game play
  ...
  /**
   * Calls the Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address) ABI method.
   *
   * Returns the current state of the game
   *
   * @param args The arguments for the contract call
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  game(params?: CallParams<AvmSatoshiDiceArgs['obj']['Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | AvmSatoshiDiceArgs['tuple']['Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)']>): AvmSatoshiDiceComposer<[...TReturns, AvmSatoshiDiceReturns['Game(address,uint64)(uint256,uint64,bool,bool,bool,uint64,uint64,uint64,uint64,uint256,uint64,uint256,uint64,address)'] | undefined]>
